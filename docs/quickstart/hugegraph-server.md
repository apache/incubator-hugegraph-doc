...
<img src="/img/quickstart/swagger-ui.png" alt="image" />
...
<img src="/img/quickstart/swagger-ui-where-set-auth-example.png" alt="image" />

Currently, HugeGraph supports setting authentication information in two forms: Basic and Bearer.

<img src="/img/quickstart/swagger-ui-set-auth-example.png" alt="image" />
