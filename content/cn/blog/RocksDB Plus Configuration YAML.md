...
linkTitle: "RocksDB Plus的YAML配置文件"
---

RocksDB 提供了丰富的参数配置，但大多数情况下，这些配置需要通过硬编码完成。

RocksDB Plus ([ToplingDB](https://github.com/topling/toplingdb)) 在此基础上引入了 **SidePlugin + YAML** 的方式，使得配置更加模块化和可组合。

本文重点介绍 **RocksDB Plus 扩展参数** 的部分，帮助读者理解这些配置的意义。
