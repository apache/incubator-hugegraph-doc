...
------------------------- | --------------------------------------------- | ---------------------------------------------------------------------------------------
backend                   | cassandra                                     | The data store type, available values are [memory, cassandra, rocksdb, scylladb, mysql]
serializer                | cassandra                                     | The serializer for backend store, available values are [text, cassandra, binary, mysql]
...
rocksdb.data_disks                             | []            | The optimized disks for storing data of RocksDB. The format of each element: `STORE/TABLE: /path/to/disk`
